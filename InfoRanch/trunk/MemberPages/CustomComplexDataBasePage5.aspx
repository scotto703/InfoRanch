<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/PageDesignFiles/MemberPage.master" CodeBehind="CustomComplexDataBasePage5.aspx.vb" Inherits="InfoRanch.CustomComplexDataBasePage5" %>
    ...
    <table style="width: 100%; height: 509px; background-color:#99CCFF;">
        <tr>
            <td style="width: 766px; height: 23px;">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="coralCnameLabel" runat="server" Font-Names="Arial" Font-Size="Small" 
                    ForeColor="Maroon" 
                    Text="Please enter the name for the third table (or accept the default): "></asp:Label>
                &nbsp;
                <asp:TextBox ID="NameTB" 
                    runat="server" Width="257px">manufacturer</asp:TextBox>
                </td>
        ...
        <tr>
            <td style="width: 766px; height: 23px">
                ...
                &nbsp;&nbsp;&nbsp;<asp:TextBox ID="categoryTB" runat="server" Width="260px">manufacturer ID</asp:TextBox>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
