<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/PageDesignFiles/MemberPage.master" CodeBehind="CustomComplexConfirm.aspx.vb" Inherits="InfoRanch.CustomComplexConfirm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="yesNoLael" runat="server" Font-Bold="True" Font-Names="Arial" 
        Font-Size="Medium" ForeColor="Maroon" Text="Continue?  "></asp:Label>
    <asp:Button ID="yesButton" runat="server" Text="Yes" />
    <asp:Button ID="noButton" runat="server" Text="No" Width="41px" />
    <br />
    <br />
    <br />
    <br />
