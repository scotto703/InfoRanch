...
Public Class CustomComplexDataBasePage5
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("selected_model") = "inventory" Then
            NameTB.Text = "manufacturer"
            categoryTB.Text = Session("foreign_key")
            'categoryTB.Text = "manufacturer ID"
            Session("user_table3_model") = "manufacturer_ID"
        ...
        If Session("selected_model") = "corporate_employee" Then
            NameTB.Text = "corporate"
            categoryTB.Text = "division number"
            Session("user_table3_model") = "division_number"
            categoryTB2.Text = "division name"
        ...
        If Session("selected_model") = "acquaintance_information" Then
            NameTB.Text = "acquaintance phone"
            categoryTB.Text = "phone"
            Session("user_table3_model") = "phone"
            categoryTB2.Text = "acquaintanceID"
            categoryTB3.Visible = False
            categoryTB4.Visible = False
            categoryTB5.Visible = False
            categoryTB6.Visible = False
